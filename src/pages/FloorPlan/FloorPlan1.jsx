...
<Helmet>
		...
		{/* SEO 최적화를 위한 메타 태그 */}
		<title>대전하늘채스카이앤3차 - 평면안내</title>
		<meta
		  name="description"
		  content="대전 하늘채 스카이앤 3차의 평면도를 통해 세대별 구조와 공간 활용도를 확인하세요. 실용적이고 혁신적인 설계를 기반으로 한 다양한 평면 구성이 여러분의 생활을 더 편리하게 만듭니다.
"
		/>
		<meta
		  name="keywords"
		...
		/>
		<link rel="canonical" href="https://www.kikaporn.com/FloorPlan/59A" />

		{/* Open Graph - 소셜 미디어 공유 최적화 */}
		<meta
		  property="og:title"
		  content="대전하늘채스카이앤3차 - 평면안내"
		/>
		<meta
...
"
		...
		<meta
		  property="og:url"
		  content="https://www.kikaporn.com/FloorPlan/59A"
		/>
